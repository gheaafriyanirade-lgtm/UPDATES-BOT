...
// Each product has a name and a download link (empty until admin sets it)
// This file is the single source of truth for all 57 products.
...
// In-memory URL store — overrides default empty URLs at runtime
// key: product id → url string
const urlOverrides = {};
...
// Split into chunks for Discord's 25-option select menu limit
