...
client.on('interactionCreate', async interaction => {
  ...
  if (interaction.isModalSubmit() && interaction.customId === 'update_modal') {
    ...
    // Use custom title if provided, otherwise use type label bold in description
    const embedTitle = customTitle ? customTitle.toUpperCase() : null;
